...
public class LoginController {
    ...
    public ResponseEntity<Map<String, String>> googleLogin(@RequestParam String code, @PathVariable String registrationId) {
        String email = loginService.socialLogin(code, registrationId); //코드를 받아 서버에 요청하여 이메일을 받아옴.
